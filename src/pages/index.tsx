...
const Page: React.FC = () => {
  ...
  return (
    <section className="flex h-screen flex-col">
      <Header />
      <div className="flex flex-auto flex-col items-center justify-center gap-y-12">
        <Form<{
        ...
        >
          <Form.Item
            ...
            rules={[
              { required: true, message: t('Please select scan object') },
            ]}
          >
            <Select
              autoFocus
              ...
              options={scanObjects.map(
                ({ scanObjectName, scanObjectValue }) => ({
